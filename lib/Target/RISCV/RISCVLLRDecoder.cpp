...
//    Streamer->EmitInstruction(MCInstr, *STI);
  ...
  default: llvm_unreachable("Not implemented instruction");
  case RISCV::AUIPC: execution_func = exec_AUIPC; break;

  case RISCV::ADD:
  case RISCV::C_ADD: execution_func = exec_C_ADD; break;

  case RISCV::C_ADDI:
  case RISCV::ADDI: execution_func = exec_ADDI; break;

  case RISCV::C_ADDI4SPN: execution_func = exec_ADDI4SPN; break;

  case RISCV::DIV: execution_func = exec_DIV; break;

  case RISCV::SUB:
  case RISCV::C_SUB: execution_func = exec_C_SUB; break;

  case RISCV::C_LI: execution_func = exec_C_LI; break;

  case RISCV::C_LUI: execution_func = exec_C_LUI; break;

  case RISCV::LUI: execution_func = exec_LUI; break;

  case RISCV::JALR:execution_func = exec_JALR; break;


  case RISCV::JAL: execution_func = exec_JAL; break;

  case RISCV::C_JAL: execution_func = exec_C_JAL; break;

  case RISCV::C_J: execution_func = exec_J; break;

  case RISCV::C_JALR:
  case RISCV::C_JR: execution_func = exec_JR; break;


  case RISCV::C_MV: execution_func = exec_C_MV; break;
  ...
  case RISCV::BGEU:
  case RISCV::BEQ:
  case RISCV::BGE: execution_func = exec_BG; break;

  case RISCV::SLTI:
  case RISCV::SLTIU:

  case RISCV::SLT:
  case RISCV::SLTU: execution_func = exec_SLT; break;

  case RISCV::XORI: execution_func = exec_XORI; break;
  case RISCV::XOR: execution_func = exec_XOR; break;


  case RISCV::AND: execution_func = exec_AND; break;

  case RISCV::C_ANDI:
  case RISCV::ANDI: execution_func = exec_ANDI; break;

  case RISCV::C_OR:
  case RISCV::OR: execution_func = exec_OR; break;

  case RISCV::ORI: execution_func = exec_ORI; break;

  case RISCV::C_BEQZ:
  case RISCV::C_BNEZ: execution_func = exec_C_BEQZ; break;
  ...
  case RISCV::SRLI:
  case RISCV::C_SRLI:
      execution_func = exec_SHIFT; break;

  case RISCV::SB:
  case RISCV::SH:
  case RISCV::C_SW:
  case RISCV::C_SWSP:
  case RISCV::SW: execution_func = exec_STORE; break;
  ...
  case RISCV::C_LW:
  case RISCV::C_LWSP:
  case RISCV::LW: execution_func = exec_LOAD; break;

  case RISCV::CSRRCI:
  case RISCV::CSRRC: execution_func = exec_CSRRC; break;


  case RISCV::CSRRSI:
  case RISCV::CSRRS: execution_func = exec_CSRRS; break;

  case RISCV::CSRRWI:
  case RISCV::CSRRW: execution_func = exec_CSRRW; break;

  case RISCV::ECALL: execution_func = exec_ECALL; break;


  case RISCV::URET:
  case RISCV::SRET:
  case RISCV::MRET: execution_func = exec_xRET; break;

  case RISCV::FENCE_I:
  case RISCV::FENCE: execution_func = exec_NOP;
  }

  LLRInst llrInst(MCInstr, Size, Ctx, execution_func);
  llrInst.dump();
